...
const agents = [
  {
    ...
    name: 'Sol',
    role: 'Commander',
    oneLiner: 'Orchestrates, learns from mistakes, gets better',
    color: 'var(--color-sol)',
    glowClass: 'glow-sol',
  },
  {
    ...
    name: 'Apex',
    role: 'CTO',
    oneLiner: 'Ships 36+ versions in 8 days',
  ...
  },
  {
    ...
    name: 'Lux',
    role: 'CDO',
    oneLiner: 'Design critiques, UX polish',
    color: 'var(--color-lux)',
    glowClass: 'glow-lux',
  },
  {
    ...
    name: 'Nova',
    role: 'CFO',
    oneLiner: 'Financial analysis & margin tracking',
